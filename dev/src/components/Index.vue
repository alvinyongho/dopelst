<template>
  <div class="landing">
    <div class="v-center">
      <img src="../assets/dopLstlogo.png" alt="logo" class="logo" />
      <div class="tagline">MANAGE YOUR MUSIC IN ONE PLACE</div><!-- .tagline -->
      <div class="link" v-on:click="linkClicked">GET STARTED</div><!-- .link -->
    </div><!-- .v-center -->
  </div><!-- .landing -->
</template>
